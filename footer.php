            ...
            <ul class="footer-social__list">
              <?php if (get_field('contacts_link_video', 'option')): ?>
                <li class="footer-social__item">
                  <a href="<?php the_field('contacts_link_video', 'option'); ?>" target="_blank" class="link footer-social__link footer-social__link--video" aria-label="Ссылка на наш Ютуб канал">
              ...
              <?php if (get_field('contacts_link_telegram', 'option')): ?>
                <li class="footer-social__item">
                  <a href="<?php the_field('contacts_link_telegram', 'option'); ?>" target="_blank" class="link footer-social__link footer-social__link--telegram" aria-label="Ссылка на наш telegram">
                    <svg viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <?php if (get_field('contacts_link_vk', 'option')): ?>
                <li class="footer-social__item">
                  <a href="<?php the_field('contacts_link_vk', 'option'); ?>" target="_blank" class="link footer-social__link footer-social__link--vk" aria-label="Ссылка на наш вконтакте">
